...
#define USBD_MANUFACTURER_STRING      "KFoltman" /* Add your manufacturer string */
#define USBD_PRODUCT_FS_STRING        "TinyDRO" /* Add your product Full Speed string */
#define USBD_CONFIGURATION_FS_STRING  "Default" /* Add your configuration Full Speed string */
#define USBD_INTERFACE_FS_STRING      "Serial" /* Add your Interface Full Speed string */
...
/* Private variables ---------------------------------------------------------*/
USBD_DescriptorsTypeDef ACM_Desc =
{
